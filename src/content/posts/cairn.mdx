...
import bivouac from '../../assets/cairn-bivouac.jpg';

Je viens de finir Cairn, un jeu d'escalade français. Je vais l'annoncer d'entrée de jeu : c'est mon deuxième meilleur jeu de tous les temps, après [Outer Wilds](https://store.steampowered.com/app/753640/Outer_Wilds/). Rien que ça.
...
<AppImage src={bivouac} alt="Bivouac dans Cairn" caption="Fond d'écran offert trouvable dans le jeu" />
